# RevitAddin - Documentation Wiki.js
...
## Parcours conseillé dans ce wiki

1. Lire la page **Vue d'ensemble** pour comprendre le périmètre du projet.
2. Consulter **Architecture** pour voir comment l'add-in est structuré.
3. Parcourir les pages **Fonctions** selon le panneau Revit concerné.
4. Terminer par **Installation add-in** pour la mise en place sur un poste utilisateur.

## Public visé

Ce wiki est utile pour :
